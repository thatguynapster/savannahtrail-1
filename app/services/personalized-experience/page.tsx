            ...
            >
                ...
                <div className="container mx-auto px-4 h-full flex items-center justify-center relative z-10">
                    <div className="text-center text-white">
                        <h1 className="text-5xl font-cursive font-bold">Personalized Experience</h1>
                        <h2 className="mt-8 text-3xl capitalize">Your Journey, Your Way</h2>
                    </div>
                </div>
            </div>
            ...
            <div className="container mx-auto pt-12 px-4">
                <div className="text-center mb-8">
                    <p className="text-gray-600 max-w-2xl mx-auto mt-4">
                        Design a travel experience that’s uniquely yours. From private tours to custom group itineraries, we help you choose your dates, interests, and pace—creating a journey that reflects your personal connection to Africa.
                    </p>
                </div>
