            ...
            >
                ...
                <div className="container mx-auto px-4 h-full flex items-center justify-center relative z-10">
                    <div className="text-center text-white">
                        <h1 className="text-5xl font-cursive font-bold">Car Rental Services</h1>
                        <h2 className="mt-8 text-3xl capitalize">Explore at Your Own Pace</h2>
                    </div>
                </div>
            </div>
            ...
            <div className="container mx-auto pt-12 px-4">
                <div className="text-center mb-8">
                    <p className="text-gray-600 max-w-2xl mx-auto mt-4">
                        Get around easily with our reliable car rental services. Whether you need a self-drive option or a chauffeured vehicle, we offer flexible, comfortable transportation tailored to your itinerary.
                    </p>
                </div>
